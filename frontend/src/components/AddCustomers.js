  ...
  return (
    ...
    <button onClick={handleShow} 
      ...
      >
        ...
        setName('');
        setIndustry('');
       props.AddCustomers(name,industry);
        }
        }
        id='editmodel' className="w-full max-w-sm">
            ...
            <div className="md:flex md:items-center mb-6">
                ...
                id="industry" 
                placeholder='manager'
                type="text" value={industry} onChange={(e) => {
        ...
        <Modal.Footer>.
          ...
          <button className='bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded' form='editmodel' onClick={ handleClose}>Add </button>
          <button className='bg-slate-400 hover:bg-red-400 text-white font-bold py-2 px-4 rounded' onClick={handleClose} >close</button>
